  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 25% 10%, rgba(var(--primary), 0.15), transparent 40%), radial-gradient(circle at 75% 75%, rgba(var(--primary), 0.1), transparent 40%)",
        }}
      ></div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="parallax-scroll">
          ...
          <p
            className={`text-center text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-16 ${isSectionVisible ? "fade-in" : "opacity-0"}`}
            style={{ animationDelay: "0.2s" }}
          >
            A showcase of my recent work spanning web development, machine
            learning, and technical problem-solving. Hover on the Projects to
